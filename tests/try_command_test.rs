use clap::Parser;
use squrl::cli::commands::request_commands::new::NewRequestCommand;
use squrl::cli::commands::request_commands::send::SendCommand;
use squrl::cli::commands::try_command::TryCommand;
