...
impl DigestAlgorithm {
	...
	fn to_digest_auth_algorithm(&self) -> digest_auth::Algorithm {
		match self {
			DigestAlgorithm::MD5 => {
				digest_auth::Algorithm::new(digest_auth::AlgorithmType::MD5, false)
			}
			DigestAlgorithm::MD5Sess => {
				digest_auth::Algorithm::new(digest_auth::AlgorithmType::MD5, true)
			}
			DigestAlgorithm::SHA256 => {
				digest_auth::Algorithm::new(digest_auth::AlgorithmType::SHA2_256, false)
			}
			DigestAlgorithm::SHA256Sess => {
				digest_auth::Algorithm::new(digest_auth::AlgorithmType::SHA2_256, true)
			}
			DigestAlgorithm::SHA512 => {
				digest_auth::Algorithm::new(digest_auth::AlgorithmType::SHA2_512_256, false)
			}
			DigestAlgorithm::SHA512Sess => {
				digest_auth::Algorithm::new(digest_auth::AlgorithmType::SHA2_512_256, true)
			}
		}
	}
}
