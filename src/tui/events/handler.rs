	...
	async fn handle_key(
		...
		match matching_event.as_ref() {
			...
			Some(event) => match event {
				...
				| AppEvent::EditGrpcProtoFile(_)
				| AppEvent::EditGrpcService(_)
				| AppEvent::EditGrpcMethod(_)
				| AppEvent::EditGrpcMessage(_)
				...
				| AppEvent::ModifyGrpcService(_)
				| AppEvent::CancelEditGrpcService(_)
				| AppEvent::KeyEventEditGrpcService(_)
				| AppEvent::ModifyGrpcMethod(_)
				| AppEvent::CancelEditGrpcMethod(_)
				| AppEvent::KeyEventEditGrpcMethod(_)
