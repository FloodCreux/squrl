...
impl App<'_> {
	pub fn modify_request_content_type(
		&mut self,
	...
	pub fn modify_request_form_data(
		&mut self,
		collection_index: usize,
		request_index: usize,
		value: String,
